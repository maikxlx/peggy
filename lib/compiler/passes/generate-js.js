...
function generateJS(ast, options) {
  ...
  function generateRuleFooter(ruleNameCode, resultCode) {
    ...
    parts.push(
      "",
      "if ("+ resultCode +" !== peg$FAILED) {",
      "  var p1 = peg$savedPos;",  // not sure if needed
      "  peg$savedPos = p0;", // enable text() to work properly
      "  var nd = {",  // nodedata
      "    rulename: " + ruleNameCode + ",",
      "    text: input.substring(p0, peg$currPos),",
      "  };",
      "  " + resultCode + " = processResult(" + resultCode + ", nd);",
      "  peg$savedPos = p1;",  // restore it juuust in case
      "}",
      "return " + resultCode + ";"
    );
  ...
  function generateToplevel() {
    ...
    parts.push(
      "  var peg$result;",
      "  var ruledataStack;", // can a tracer handle this?
      "",
      ...
      "  }",
      "",
      "  function processResult(result, nodedata) {",
      "    return result;",
      "  }",
      "",
      "  function offset() {",
